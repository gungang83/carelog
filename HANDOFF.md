...
1. **대표님**: Supabase SQL Editor에서 `supabase/migrations/20260705000002_announcements.sql` 실행. (미실행이어도 티커만 안 뜰 뿐 에러 없음 — 안전)
...
| spec 022 | 공지·업데이트 티커 + 슈퍼어드민 발행 | `20260705000002_announcements.sql` | ✅ 설계 확정 · ⚠️ SQL 미실행 |
...
---
_작성: 다온 · 2026-07-05 세션 65 · 다음 액션은 대표님 SQL 실행 → 마무리 신호._
