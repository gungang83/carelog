...
export const UPDATE_FEED: UpdateFeedEntry[] = [
  ...
  {
    id: "2026-08-09-realtime-interpret",
    date: "2026-08-09",
    emoji: "🌐",
    title: "실시간 통역 (실험실)",
    items: [
      "외국인 환자 상담 중 화면에 원문과 번역이 실시간으로 표시됩니다 — 녹음 중 '🌐 통역' 버튼을 눌러보세요. 한국어·영어가 섞인 대화도 문장 단위로 번역됩니다.",
      "통역을 마치고 '기록에 담기'를 누르면 대화 전체가 원문·번역 쌍으로 상담 기록에 남아 환자에게도 전달할 수 있습니다.",
    ],
    internal: "spec 030 · 세션 67b · 실험실(예미안) 전용 PoC",
  },
  {
    id: "2026-08-09-engine-credits",
    date: "2026-08-09",
    emoji: "🪙",
    title: "엔진별 크레딧 표기 + 소진 안내",
    items: [
      "녹음 엔진 버튼마다 소모 크레딧이 표시되어 사용 전에 소모량을 알 수 있습니다 (실시간 통역은 분당 1).",
      "크레딧이 다 떨어져도 기본 전사는 계속 쓸 수 있고, 프리미엄 엔진만 충전 후 이용하도록 안내됩니다. 소진이 가까워지면 관리자 알림함으로 미리 알려드려요.",
    ],
    internal: "spec 030 §2·§3 · 세션 67b~c",
  },
  {
    id: "2026-08-13-multi-image-remote-close",
    date: "2026-08-13",
    emoji: "🛠",
    title: "자료 여러 장 담기 + 방치 상담 원격 정리",
    items: [
      "상담 기록에 이미지·자료를 여러 장 연속으로 담을 때 앞 장이 사라지던 문제를 고쳤습니다.",
      "다른 컴퓨터에 열려 있는 '진행 중인 상담'을 홈에서 바로 '종료·저장'할 수 있습니다 — 어느 자리인지 찾으러 다닐 필요가 없어요.",
      "홈 기록 목록이 최근 5개만 보이고, 나머지는 '전체보기·검색'으로 정리됐습니다.",
    ],
    internal: "세션 67c",
  },
  {
