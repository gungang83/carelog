...
export const UPDATE_FEED: UpdateFeedEntry[] = [
  ...
  {
    id: "2026-07-08-continue-consult",
    date: "2026-07-08",
    emoji: "🎙",
    title: "이어서 상담 · 녹음 없이 기록",
    items: [
      "상담 카드의 '이어서 상담'을 누르면 기존 기록이 상담보드에 열려, 새 녹음과 메모가 같은 기록에 이어집니다 — 상담자가 바뀌어도 흐름이 한 기록으로 남아요.",
      "홈의 '녹음 없이 기록만'으로 마이크 없이 보드를 열어 기록·자료·견적만 작성할 수도 있습니다(필요하면 보드 안에서 녹음 시작).",
    ],
