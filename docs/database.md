...
- 발행: cron `/api/cron/daily-usage-report`(매일 08:00 KST = `0 23 * * *`). 슈퍼어드민 알림함(recipients=email) + `sendPushToUser`(본인 기기). 열람 `/admin/usage/report/[date]`.
- migration: `20260628000003_daily_report.sql`
