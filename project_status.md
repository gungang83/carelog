...
- **마이그레이션**(`20260708000002_consult_assets_video.sql`) 실행 필요(kind·link_url 컬럼). 미실행 시 자료 조회가 빈 목록(신규 컬럼 select 실패) — 실행 전 배포 주의.
